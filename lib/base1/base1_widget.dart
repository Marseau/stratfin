...
import 'base1_model.dart';
export 'base1_model.dart';

class Base1Widget extends StatefulWidget {
  const Base1Widget({super.key});

  @override
  _Base1WidgetState createState() => _Base1WidgetState();
}

class _Base1WidgetState extends State<Base1Widget>
    with TickerProviderStateMixin {
  late Base1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Base1Model());
