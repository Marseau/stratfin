...
import 'base1_copy_model.dart';
export 'base1_copy_model.dart';

class Base1CopyWidget extends StatefulWidget {
  const Base1CopyWidget({super.key});

  @override
  _Base1CopyWidgetState createState() => _Base1CopyWidgetState();
}

class _Base1CopyWidgetState extends State<Base1CopyWidget>
    with TickerProviderStateMixin {
  late Base1CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Base1CopyModel());
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: FlutterFlowChoiceChips(
                        options: const [ChipData('Empresa'), ChipData('Consultor')],
