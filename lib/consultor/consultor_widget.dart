...
import 'consultor_model.dart';
export 'consultor_model.dart';

class ConsultorWidget extends StatefulWidget {
  const ConsultorWidget({super.key});

  @override
  _ConsultorWidgetState createState() => _ConsultorWidgetState();
}

class _ConsultorWidgetState extends State<ConsultorWidget>
    with TickerProviderStateMixin {
  late ConsultorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsultorModel());
