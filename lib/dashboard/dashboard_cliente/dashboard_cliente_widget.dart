...
import 'dashboard_cliente_model.dart';
export 'dashboard_cliente_model.dart';

class DashboardClienteWidget extends StatefulWidget {
  const DashboardClienteWidget({
    super.key,
    this.refUserAdvisor,
  });

  final String? refUserAdvisor;

  @override
  _DashboardClienteWidgetState createState() => _DashboardClienteWidgetState();
}

class _DashboardClienteWidgetState extends State<DashboardClienteWidget>
    with TickerProviderStateMixin {
  late DashboardClienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardClienteModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> dashboardClienteUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dashboardClienteUsersRecord =
            dashboardClienteUsersRecordList.isNotEmpty
                ? dashboardClienteUsersRecordList.first
                : null;
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          if (dashboardClienteUsersRecord
                                                                  ?.perfilEmpresa ==
                                                              false) {
                                                            ...
                                                            await dashboardClienteUsersRecord!
                                                                .reference
                                                                .update(
                                                                                    ...
                                                                                    child: SizedBox(
                                                                                      ...
                                                                                      child: TextFormField(
                                                                                        controller: _model.bioController ??= TextEditingController(
                                                                                          text: dashboardClienteUsersRecord?.bio,
                                                                                        ),
